...
- **`notebooks/`**
  ...
  - `segmentation_myelin.ipynb`: Jupyter Notebook з темплейтом для майбутньої сегментації мієлінових оболонок (_поки відсутній тут через відсутність даних_).
  - `analysis_myelin.Rmd`: Темплейт для аналізу морфометричних показників мієлінових оболонок, отриманих на основі зображень (_поки відсутній тут через відсутність даних_)
...
- **`results/`**
  ...
  - `results_myelin/`: Папка з результатами сегментації аксонів (_поки відсутня тут через відсутність даних_):
